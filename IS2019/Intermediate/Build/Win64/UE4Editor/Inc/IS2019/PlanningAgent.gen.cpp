...
#include "IS2019/PlanningAgent.h"
#ifdef _MSC_VER
#pragma warning (push)
...
// Cross Module References
	IS2019_API UClass* Z_Construct_UClass_APlanningAgent_NoRegister();
	IS2019_API UClass* Z_Construct_UClass_APlanningAgent();
...
// End Cross Module References
...
#if WITH_METADATA
		static const UE4CodeGen_Private::FMetaDataPairParam NewProp_m_basicEnemyClass_MetaData[];
#endif
		static const UE4CodeGen_Private::FClassPropertyParams NewProp_m_basicEnemyClass;
...
#endif
	const UE4CodeGen_Private::FUnsizedIntPropertyParams Z_Construct_UClass_APlanningAgent_Statics::NewProp_m_maxEnemies = { "m_maxEnemies", nullptr, (EPropertyFlags)0x0020080000000001, UE4CodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(APlanningAgent, m_maxEnemies), METADATA_PARAMS(Z_Construct_UClass_APlanningAgent_Statics::NewProp_m_maxEnemies_MetaData, ARRAY_COUNT(Z_Construct_UClass_APlanningAgent_Statics::NewProp_m_maxEnemies_MetaData)) };
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_APlanningAgent_Statics::NewProp_m_basicEnemyClass_MetaData[] = {
		{ "Category", "Enemy Spawn" },
		{ "ModuleRelativePath", "PlanningAgent.h" },
	};
#endif
	const UE4CodeGen_Private::FClassPropertyParams Z_Construct_UClass_APlanningAgent_Statics::NewProp_m_basicEnemyClass = { "m_basicEnemyClass", nullptr, (EPropertyFlags)0x0024080000000001, UE4CodeGen_Private::EPropertyGenFlags::Class, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(APlanningAgent, m_basicEnemyClass), Z_Construct_UClass_AEnemyAgent1_NoRegister, Z_Construct_UClass_UClass, METADATA_PARAMS(Z_Construct_UClass_APlanningAgent_Statics::NewProp_m_basicEnemyClass_MetaData, ARRAY_COUNT(Z_Construct_UClass_APlanningAgent_Statics::NewProp_m_basicEnemyClass_MetaData)) };
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_APlanningAgent_Statics::PropPointers[] = {
		...
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_APlanningAgent_Statics::NewProp_m_basicEnemyClass,
	};
	...
	IMPLEMENT_CLASS(APlanningAgent, 2971855522);
	template<> IS2019_API UClass* StaticClass<APlanningAgent>()
	{
		return APlanningAgent::StaticClass();
	}
	static FCompiledInDefer Z_CompiledInDefer_UClass_APlanningAgent(Z_Construct_UClass_APlanningAgent, &APlanningAgent::StaticClass, TEXT("/Script/IS2019"), TEXT("APlanningAgent"), false, nullptr, nullptr, nullptr);
